...
export default function OrganizationForm({ handleSubmit, renderField }) {
    return (
        <Form className="container" onSubmit={handleSubmit} >
            ...
            <Field name="FundingPartner" label="Are you a Funding Partner ?: " component={renderField} type="select" options={["Yes", "No"]}/>
            ...
            <Field name="ContactPerson" label="Contact Person: " component={renderField} type="text" />
